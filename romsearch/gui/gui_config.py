...
class ConfigWindow(QMainWindow):
    ...
    def __init__(
        ...
        self.all_dirs = {
            ...
            "mapped_dat_dir": self.ui.lineEditConfigMappedDatDir,
        ...
        self.all_dirs_buttons = {
            ...
            "mapped_dat_dir": self.ui.pushButtonConfigMappedDatDir,
        ...
        self.all_romsearch_options = {
            ...
            "run_datmapper": self.ui.checkBoxConfigRunDatMapper,
            ...
            "separate_directories": self.ui.checkBoxConfigSeparateDirectories,
